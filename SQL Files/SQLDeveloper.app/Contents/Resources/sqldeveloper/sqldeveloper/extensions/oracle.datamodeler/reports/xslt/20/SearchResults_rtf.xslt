...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_srs_ml" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:variable name="altova:DocumentMonolith">
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<altova:DocumentSection altova:PageWidthPt="841" altova:MarginLeftPt="43" altova:MarginRightPt="43" altova:PageHeightPt="595" altova:MarginTopPt="56" altova:MarginBottomPt="56" altova:Columns="1" altova:ColumnGapPt="36" altova:RtfSectionIntro="\sectd"/>
			<xsl:text>\facingp\pgwsxn16820\pghsxn11900\lndscpsxn\margtsxn-1120\marglsxn860\margbsxn-1120\margrsxn860\headery420\footery420\cols1\colsx720\pgndec</xsl:text>
			<xsl:text>{</xsl:text>
						...
						<xsl:choose>
							<xsl:when test="../n1:multiLevel = &apos;true&apos;">
								<xsl:for-each select="n1:object">
									<altova:bookmark name="{n1:values/n1:v0}"/>
									<xsl:variable name="altova:CurrContextGrid_3" select="."/>
									<altova:table>
										<xsl:variable name="altova:ColumnData"/>
										<altova:TableGrid>
											<xsl:if test="$s0_c1_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c2_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c3_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c4_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c5_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c6_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c7_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c8_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c9_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c10_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c11_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c12_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c13_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c14_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c15_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c16_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c17_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c18_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c19_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c20_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c21_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c22_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c23_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c24_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c25_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c26_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c27_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c28_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c29_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
											<xsl:if test="$s0_c30_show">
												<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
											</xsl:if>
										</altova:TableGrid>
										<altova:TableStyles altova:nBorderSpacingPt="0.00" altova:sBorderCollapse="collapse" altova:nCellPaddingPt="2.25" altova:nLeftMarginPt="0.00">
											<xsl:text>\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
											<altova:TableWidth altova:sWidth="{../../n1:sections/n1:section0/@tw}"/>
										</altova:TableStyles>
										<altova:table-row>
											<xsl:element name="altova:TableRowStyles">
												<xsl:text>\trrh0</xsl:text>
											</xsl:element>
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c1_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c1_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c2_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c2_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c3_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c3_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c4_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c4_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c5_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c5_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c6_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c6_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c7_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c7_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c8_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c8_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c9_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c9_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c10_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c10_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c11_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c11_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c12_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c12_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c13_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c13_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c14_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c14_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c15_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c15_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c16_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c16_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c17_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c17_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c18_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c18_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c19_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c19_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c20_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c20_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c21_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c21_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c22_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c22_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c23_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c23_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c24_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c24_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c25_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c25_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c26_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c26_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c27_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c27_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c28_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c28_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c29_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c29_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:if test="$altova:CurrContextGrid_3/($s0_c30_show)">
												<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c30_width}">
													<altova:TableCellStyles altova:nColSpan="1">
														<xsl:text>\clvertalc</xsl:text>
														<xsl:element name="altova:TableCellColor">
															<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
							...
							<xsl:otherwise>
								...
								<altova:table>
									...
									<altova:table-row>
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c1_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c1_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c2_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c2_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c3_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c3_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c4_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c4_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c5_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c5_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c6_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c6_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c7_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c7_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c8_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c8_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c9_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c9_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c10_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c10_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c11_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c11_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c12_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c12_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c13_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c13_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c14_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c14_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c15_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c15_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c16_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c16_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c17_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c17_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c18_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c18_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c19_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c19_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c20_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c20_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c21_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c21_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c22_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c22_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c23_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c23_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c24_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c24_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c25_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c25_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c26_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c26_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c27_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c27_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c28_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c28_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c29_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c29_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
										...
										<xsl:if test="$altova:CurrContextGrid_4/($s0_c30_show)">
											<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$s0_c30_width}">
												<altova:TableCellStyles altova:nColSpan="1">
													<xsl:text>\clvertalc</xsl:text>
													<xsl:element name="altova:TableCellColor">
	...
	<xsl:template name="L1_template">
		...
		<xsl:if test="$sectionData/n1:object/n1:values/*[text()]">
			<altova:new-line/>
			<altova:paragraph altova:whitespace="preserve-all" altova:left-indent-tw="300" altova:selector="div*" altova:character-styles="\f0\fs24" altova:paragraph-styles="\sl0" altova:is-div="true">
				<xsl:for-each select="$sectionDescription">
					<xsl:for-each select="@name">
						<altova:text-block altova:whitespace="preserve-all" altova:selector="*" altova:character-styles="\i" altova:character-reset-styles="\i0">
							<altova:string-to-unicode>
					...
					<altova:table>
						<xsl:variable name="altova:ColumnData"/>
						<altova:TableGrid>
							<xsl:if test="$c1_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c2_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c3_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c4_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c5_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c6_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c7_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c8_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c9_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c10_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c11_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c12_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c13_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c14_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c15_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c16_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c17_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c18_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c19_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c20_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c21_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c22_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c23_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c24_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c25_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c26_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c27_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c28_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c29_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
							<xsl:if test="$c30_show = &apos;true&apos;">
								<altova:GridCol altova:sWidth="0" altova:sType="auto"/>
							</xsl:if>
						</altova:TableGrid>
						<altova:TableStyles altova:nBorderSpacingPt="0.00" altova:sBorderCollapse="collapse" altova:nCellPaddingPt="2.25" altova:nLeftMarginPt="0.00">
							<xsl:text>\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
							<altova:TableWidth altova:sWidth="{$sectionDescription/@tw}"/>
						</altova:TableStyles>
						<altova:table-row>
							<xsl:element name="altova:TableRowStyles">
								<xsl:text>\trrh0</xsl:text>
							</xsl:element>
							<xsl:if test="$altova:CurrContextGrid_5/($c1_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c1_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
										</xsl:element>
										<altova:Borders>
											<altova:Top>
												<xsl:text>\clbrdrt</xsl:text>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c2_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c2_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c3_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c3_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c4_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c4_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c5_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c5_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c6_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c6_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c7_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c7_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c8_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c8_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c9_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c9_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c10_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c10_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c11_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c11_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c12_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c12_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c13_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c13_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c14_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c14_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c15_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c15_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c16_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c16_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c17_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c17_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c18_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c18_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c19_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c19_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c20_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c20_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c21_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c21_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c22_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c22_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c23_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c23_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c24_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c24_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c25_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c25_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c26_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c26_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c27_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c27_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c28_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c28_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c29_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c29_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
							...
							<xsl:if test="$altova:CurrContextGrid_5/($c30_show = &apos;true&apos;)">
								<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0" width="{$c30_width}">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#f2fff6'"/>
						...
						<xsl:for-each select="n1:values">
							...
							<altova:table>
								...
								<altova:table-row>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c1_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c1_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Bottom>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c2_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c2_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Bottom>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c3_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c3_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Bottom>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c4_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c4_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Bottom>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c5_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c5_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Bottom>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c6_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c6_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Bottom>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c7_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c7_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Bottom>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c8_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c8_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Bottom>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c9_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c9_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Bottom>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c10_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c10_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Bottom>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c11_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c11_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Bottom>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c12_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c12_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c13_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c13_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c14_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c14_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c15_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c15_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c16_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c16_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c17_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c17_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c18_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c18_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c19_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c19_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c20_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c20_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c21_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c21_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c22_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c22_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c23_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c23_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c24_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c24_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c25_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c25_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c26_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c26_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c27_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c27_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c28_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c28_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c29_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c29_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
									...
									<xsl:if test="$altova:CurrContextGrid_6/($c30_show = &apos;true&apos;)">
										<altova:table-cell altova:whitespace="preserve-all" altova:paragraph-styles="\sl0" width="{$c30_width}">
											<altova:TableCellStyles altova:nColSpan="1">
												<xsl:text>\clvertalc</xsl:text>
												<altova:Borders>
													<altova:Top>
		...
		<altova:table>
			...
			<altova:table-row>
				...
				<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
					...
					<altova:text-block altova:whitespace="preserve-all" altova:selector="*">
						<xsl:text>\u79?\u114?\u97?\u99?\u108?\u101?\u32?\u83?\u81?\u76?\u32?\u68?\u101?\u118?\u101?\u108?\u111?\u112?\u101?\u114?\u32?\u68?\u97?\u116?\u97?\u32?\u77?\u111?\u100?\u101?\u108?\u101?\u114?</xsl:text>
					</altova:text-block>
				</altova:table-cell>
	...
	<xsl:variable name="altova:paragraph-style-selectors-in-use" select="('p','div','address','center','blockquote','fieldset','pre','pre-wrap','h1','h2','h3','h4','h5','h6','center*','div*')"/>
	...
	<xsl:template match="/">
		<xsl:for-each select="$altova:nodesAllSeparateDocuments">
			...
			<xsl:result-document href="{$altova:nodeDocument/@altova:Url}">
				...
				<xsl:text>{\s16\sl0\li300\f0\fs24\snext0 Paragraph ;}</xsl:text>
				<xsl:text>{\*\cs17\fs26\b\snext0 Character ;}</xsl:text>
				<xsl:text>}</xsl:text>
