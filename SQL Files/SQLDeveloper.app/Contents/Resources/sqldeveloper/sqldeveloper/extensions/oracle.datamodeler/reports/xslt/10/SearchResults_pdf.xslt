...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_srs_ml" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link n1 sps xbrldi xbrli xlink xs xsi">
		...
		<fo:root>
												...
												<xsl:variable name="altova:bookmark-title">
													...
													<xsl:choose>
														<xsl:when test="contains(string($value-of-template_2),'&#x200B;')">
															<fo:block border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
																<xsl:copy-of select="$value-of-template_2"/>
															</fo:block>
														</xsl:when>
														<xsl:otherwise>
															<fo:inline border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
																<xsl:copy-of select="$value-of-template_2"/>
															</fo:inline>
														</xsl:otherwise>
													</xsl:choose>
			...
			<fo:page-sequence force-page-count="no-force" master-reference="page-master-0" initial-page-number="auto" format="1">
				<fo:static-content flow-name="odd-page-footer">
					<fo:block-container height="1.25cm" overflow="hidden" display-align="after">
						<fo:block font-family="Tahoma" font-size="xx-small">
							...
							<fo:table border-collapse="collapse" empty-cells="show" font-size="xx-small" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" width="25cm">
								<fo:table-column column-width="18cm"/>
								<fo:table-column column-width="7cm"/>
								<xsl:variable name="altova:CurrContextGrid_3" select="."/>
								<fo:table-body border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" start-indent="0pt">
									<xsl:variable name="altova:tablerows">
										<fo:table-row border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
											<fo:table-cell border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="3" display-align="center">
												<fo:block-container overflow="hidden">
													<fo:block text-align="left">
														<fo:inline border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
															<xsl:text>Oracle SQL Developer Data Modeler</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:block-container>
											</fo:table-cell>
											<fo:table-cell border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="3" display-align="center">
												<fo:block-container overflow="hidden">
													<fo:block text-align="right">
														...
														<fo:page-number border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed"/>
														<fo:inline border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
															<xsl:text> / </xsl:text>
														</fo:inline>
														<fo:page-number-citation ref-id="SV_RefID_PageTotal" border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed"/>
													</fo:block>
												</fo:block-container>
											</fo:table-cell>
										</fo:table-row>
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:block font-family="Tahoma" font-size="xx-small" border-collapse="collapse" empty-cells="show" font-weight="normal" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
						<fo:inline-container>
							<fo:block>
								<xsl:text>&#x200B;</xsl:text>
							</fo:block>
						</fo:inline-container>
						<fo:block border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" margin-right="100% - 100%" text-align="center" space-before="0" space-after="0" margin="0pt">
							<xsl:for-each select="$XML">
								<xsl:for-each select="n1:searchResults">
									<xsl:for-each select="n1:title">
										...
										<xsl:choose>
											<xsl:when test="contains(string($value-of-template_4),'&#x200B;')">
												<fo:block border-collapse="collapse" empty-cells="show" font-size="medium" font-weight="bold" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
													<xsl:copy-of select="$value-of-template_4"/>
												</fo:block>
											</xsl:when>
											<xsl:otherwise>
												<fo:inline border-collapse="collapse" empty-cells="show" font-size="medium" font-weight="bold" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
													<xsl:copy-of select="$value-of-template_4"/>
												</fo:inline>
											</xsl:otherwise>
										</xsl:choose>
						...
						<xsl:for-each select="$XML">
							...
							<xsl:if test="n1:searchResults/n1:showFilter  = &apos;true&apos;">
								...
								<fo:table border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" width="8cm">
									...
									<xsl:choose>
										<xsl:when test="../n1:multiLevel = &apos;true&apos;">
											<xsl:for-each select="n1:object">
												...
												<fo:table border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" width="100%">
													<xsl:variable name="sWidth">
														<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
															<xsl:with-param name="sValue" select="../../n1:sections/n1:section0/@tw"/>
														</xsl:call-template>
													</xsl:variable>
													<xsl:if test="$sWidth != ''">
													...
													<xsl:if test="$s0_c1_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c1_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
																	<xsl:value-of select="$sColumn-width"/>
																</xsl:attribute>
															</xsl:if>
														</fo:table-column>
													</xsl:if>
													<xsl:if test="$s0_c2_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c2_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c3_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c3_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c4_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c4_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c5_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c5_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c6_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c6_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c7_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c7_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c8_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c8_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c9_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c9_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c10_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c10_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c11_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c11_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c12_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c12_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c13_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c13_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c14_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c14_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c15_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c15_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c16_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c16_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c17_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c17_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c18_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c18_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c19_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c19_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c20_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c20_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c21_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c21_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c22_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c22_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c23_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c23_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c24_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c24_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c25_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c25_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c26_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c26_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c27_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c27_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c28_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c28_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c29_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c29_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<xsl:if test="$s0_c30_show">
														<fo:table-column>
															<xsl:variable name="sColumn-width">
																<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
																	<xsl:with-param name="sValue" select="$s0_c30_width"/>
																</xsl:call-template>
															</xsl:variable>
															<xsl:if test="$sColumn-width != ''">
																<xsl:attribute name="column-width">
													...
													<fo:table-body border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" start-indent="0pt">
														<xsl:variable name="altova:tablerows">
															<fo:table-row background-color="#d9f5ff" border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
																<xsl:variable name="bColumnCondition_0x9EE7440">
																	<xsl:for-each select="$altova:CurrContextGrid_8">
																		<xsl:value-of select="$s0_c1_show"/>
																	</xsl:for-each>
																</xsl:variable>
																<xsl:if test="$bColumnCondition_0x9EE7440 = 'true'">
																	<fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="thin" border-collapse="collapse" border-left-color="black" border-left-style="solid" border-left-width="thin" border-right-color="black" border-right-style="solid" border-right-width="thin" border-top-color="black" border-top-style="solid" border-top-width="thin" empty-cells="show" font-weight="bold" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="3" display-align="center">
																		<fo:block-container overflow="hidden">
										...
										<xsl:otherwise>
											...
											<fo:table border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" width="100%">
												<xsl:variable name="sWidth">
													<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
														<xsl:with-param name="sValue" select="../n1:sections/n1:section0/@tw != &apos;0%&apos;"/>
													</xsl:call-template>
												</xsl:variable>
												<xsl:if test="$sWidth != ''">
													<xsl:attribute name="width">
													...
													<xsl:variable name="altova:tablerows">
														<fo:table-row background-color="#d9f5ff" border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
															<xsl:variable name="bColumnCondition_0x9EE5A00">
																<xsl:for-each select="$altova:CurrContextGrid_69">
																	<xsl:value-of select="$s0_c1_show"/>
																</xsl:for-each>
															</xsl:variable>
	...
	<xsl:template name="L1_template">
		...
		<xsl:if test="$sectionData/n1:object/n1:values/*[text()]">
			...
			<fo:block border-collapse="collapse" empty-cells="show" margin-left="0.21in" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" margin-right="100% - 100%" space-before="0" space-after="0" margin="0pt">
				<xsl:for-each select="$sectionDescription">
					<xsl:for-each select="@name">
						<fo:inline border-collapse="collapse" empty-cells="show" font-style="italic" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
					...
					<fo:table border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" width="100%">
						<xsl:variable name="sWidth">
							<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
								<xsl:with-param name="sValue" select="$sectionDescription/@tw"/>
							</xsl:call-template>
						</xsl:variable>
						<xsl:if test="$sWidth != ''">
							<xsl:attribute name="width">
						...
						<xsl:if test="$c1_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c1_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c2_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c2_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c3_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c3_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c4_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c4_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c5_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c5_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c6_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c6_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c7_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c7_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c8_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c8_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c9_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c9_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c10_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c10_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c11_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c11_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c12_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c12_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c13_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c13_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c14_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c14_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c15_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c15_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c16_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c16_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c17_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c17_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c18_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c18_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c19_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c19_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c20_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c20_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c21_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c21_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c22_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c22_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c23_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c23_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c24_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c24_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c25_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c25_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c26_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c26_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c27_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c27_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c28_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c28_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c29_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c29_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<xsl:if test="$c30_show = &apos;true&apos;">
							<fo:table-column>
								<xsl:variable name="sColumn-width">
									<xsl:call-template name="altova:MakeValueAbsoluteIfPixels">
										<xsl:with-param name="sValue" select="$c30_width"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:if test="$sColumn-width != ''">
									<xsl:attribute name="column-width">
						...
						<fo:table-body border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" start-indent="0pt">
							<xsl:variable name="altova:tablerows">
								<fo:table-row background-color="#f2fff6" border-collapse="collapse" empty-cells="show" font-weight="bold" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
									<xsl:variable name="bColumnCondition_0x98DD930">
										<xsl:for-each select="$altova:CurrContextGrid_131">
					...
					<xsl:for-each select="n1:object">
						<xsl:for-each select="n1:values">
							...
							<fo:table border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" width="100%">
								...
								<xsl:variable name="altova:CurrContextGrid_162" select="."/>
								<fo:table-body border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" start-indent="0pt">
									<xsl:variable name="altova:tablerows">
										<fo:table-row border-collapse="collapse" empty-cells="show" table-layout="fixed" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed">
											<xsl:variable name="bColumnCondition_0x9AA9290">
												<xsl:for-each select="$altova:CurrContextGrid_162">
													<xsl:value-of select="$c1_show = &apos;true&apos;"/>
												</xsl:for-each>
											</xsl:variable>
