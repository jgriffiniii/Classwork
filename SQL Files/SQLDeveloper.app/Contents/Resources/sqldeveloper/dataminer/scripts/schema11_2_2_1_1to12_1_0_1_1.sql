-- schema11_2_2_1_1to12_1_0_1_1.sql is used by the migration process to migrate the XML Schema from 11.2.2.1.1 to 12.1.0.1.1
-- Usage @schema11_2_2_1_1to12_1_0_1_1.sql
-- Example: @schema11_2_2_1_1to12_1_0_1_1.sql
WHENEVER SQLERROR EXIT SQL.SQLCODE;

ALTER session set current_schema = "SYS";
/

EXECUTE dbms_output.put_line('Start Data Miner XML Schema migration from 11.2.2.1.1 to 12.1.0.1.1 ' || systimestamp);
...
--    ELSE
--    END IF;
    dbms_output.put_line('Workflow schema migration from version 11.2.2.1.1 to version 12.1.0.1.1 succeeded.');
    -- uptick the WF_VERSION
    UPDATE ODMRSYS.ODMR$REPOSITORY_PROPERTIES SET PROPERTY_STR_VALUE = '12.1.0.1.1' WHERE PROPERTY_NAME = 'WF_VERSION';
    COMMIT;
  END IF;  
EXCEPTION WHEN OTHERS THEN
  ROLLBACK;
  dbms_output.put_line('Workflow schema migration from version 11.2.2.1.1 to version 12.1.0.1.1 failed: '||DBMS_UTILITY.FORMAT_ERROR_STACK());
  RAISE;
END;
/
...
BEGIN
  ...
  IF (ver_num = '12.1.0.1.1') THEN
    ...
    COMMIT;
    dbms_output.put_line('Migrated workflows version have been updated to version 12.1.0.1.1');
  END IF;
EXCEPTION WHEN OTHERS THEN
  ROLLBACK;
...
EXECUTE dbms_output.put_line('End Data Miner XML Schema migration from 11.2.2.1.1 to 12.1.0.1.1 ' || systimestamp);
