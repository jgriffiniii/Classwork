-- schema12_1_0_1_1to12_1_0_1_2.sql is used by the migration process to migrate the XML Schema from 12_1_0_1_1 to 12.1.0.1.2
-- Usage @schema12_1_0_1_1to12_1_0_1_2.sql
...
EXECUTE dbms_output.put_line('Start Data Miner XML Schema migration from 12_1_0_1_1 to 12.1.0.1.2 ' || systimestamp);
...
--    ELSE
--    END IF;
    dbms_output.put_line('Workflow schema migration from version 12_1_0_1_1 to 12.1.0.1.2 succeeded.');
    -- uptick the WF_VERSION
    UPDATE ODMRSYS.ODMR$REPOSITORY_PROPERTIES SET PROPERTY_STR_VALUE = '12.1.0.1.2' WHERE PROPERTY_NAME = 'WF_VERSION';
    COMMIT;
  END IF;  
EXCEPTION WHEN OTHERS THEN
  ROLLBACK;
  dbms_output.put_line('Workflow schema migration from version 12_1_0_1_1 to 12.1.0.1.2 failed: '||DBMS_UTILITY.FORMAT_ERROR_STACK());
  RAISE;
END;
/
...
BEGIN
  ...
  IF (ver_num = '12.1.0.1.2') THEN
    ...
    COMMIT;
    dbms_output.put_line('Migrated workflows version have been updated to version 12.1.0.1.2');
  END IF;
EXCEPTION WHEN OTHERS THEN
  ROLLBACK;
...
EXECUTE dbms_output.put_line('End Data Miner XML Schema migration from 12_1_0_1_1 to 12.1.0.1.2 ' || systimestamp);
