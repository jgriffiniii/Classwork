...
<xs:schema xmlns="http://xmlns.oracle.com/odmr11"
           ...
           version="12.1.0.1.4" xdb:storeVarrayAsTable="true">
      ...
      <xs:complexType>
       <xs:sequence>
        <xs:element name="AnomalyDetectionModel"
                    type="AnomalyDetectionModelType" mi';
      ...
      <xs:complexType>
       <xs:sequence>
        <xs:element name="NonNegativeMatrixFactorModel" type="NonNegativeMatrixFactorModelType"
                    maxOccurs="unbounded" minOccurs="0" xdb:defaultTabl';

schema3 := 'e="NON_NEG_MATRIX_M_TAB" xdb:SQLInline="false"/>
 ...
 <xs:complexType name="KMeansAlgoType" xdb:maintainDOM="true">
  <xs:sequence>
   ...
   <xs:element name="KMNS_ITERATIONS" default="30">
    <xs:simpleType>
     <xs:restriction base="xs:integer">
      <xs:minExclusive value="0"/>
     </xs:restriction>
...
-->
 ...
 <xs:element name="PartitionExpression" type="PartitionExpres';

schema6 := 'sionType" xdb:defaultTable=""/>
